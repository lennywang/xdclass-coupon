...
public interface TUserCouponMapper {
    ...
    @Select("select id, user_coupon_code, pic_url, coupon_id, user_id, status, order_id, create_time from t_user_coupon where id = #{id,jdbcType=INTEGER}")
    TUserCoupon finudUserCouponById(@Param("id") Integer id);
